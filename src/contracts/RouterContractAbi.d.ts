...
interface RouterContractAbiInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [ContractIdInput, BigNumberish, IdentityInput]
  ): Uint8Array;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [ContractIdInput, BigNumberish, BigNumberish, IdentityInput]
  ): Uint8Array;
  encodeFunctionData(
