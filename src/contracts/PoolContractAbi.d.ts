...
interface PoolContractAbiInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "cache_vault_fees",
    values?: undefined
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: "expand_twap_buffer",
    values: [BigNumberish]
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: "get_fee_info",
    values?: undefined
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: "get_observation",
    values: [BigNumberish]
  ): Uint8Array;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "get_twap_info",
    values?: undefined
  ): Uint8Array;
  encodeFunctionData(
...
export class PoolContractAbi extends Contract {
  ...
  functions: {
    ...
    get_tokens: InvokeFunction<[], [ContractIdOutput, ContractIdOutput]>;

    get_twap_info: InvokeFunction<[], TWAPInfoOutput>;

    get_vault_info: InvokeFunction<[], VaultInfoOutput>;

    initialize: InvokeFunction<[new_vault: ContractIdInput], void>;
    ...
    withdraw_protocol_fees: InvokeFunction<
      [recipient: IdentityInput],
      [BN, BN]
    >;
  };
